...
const VenUsuario = forwardRef<VenUsuarioRefMethods, VenUsuarioProps>(
    ({ onSave, onDelete, roles }, ref) => {
        ...
        return (
            <div onClick={() => setVisible(!visible)} className="fixed z-50 backdrop-blur-sm inset-0 bg-opacity-30 flex items-center justify-center">
                <div onClick={e => e.stopPropagation()} className="bg-white rounded-lg shadow-lg w-full max-w-lg mx-3 px-0 sm:px-0 py-7 sm:py-8 overflow-y-auto">
                    <div className="px-7">
