      ...
      <div className="w-full px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            {isAnalyzing ? (
              <div className="bg-white rounded-xl shadow-sm border p-12 flex items-center justify-center h-full" style={{ borderColor: 'rgba(91, 141, 239, 0.08)' }}>
              ...
              <div className="space-y-6">
                ...
                {/* Métricas */}
                {metrics && <FinancialAnalysisMetrics metrics={metrics} />}

                {/* Gráficos */}
                {analysis.chartData && <FinancialAnalysisCharts chartData={analysis.chartData} />}

                {/* Recomendación */}
                {recommendation && <FinancialAnalysisRecommendationComponent recommendation={recommendation} />}
              </div>
            ) : (
              <div className="bg-white rounded-xl shadow-sm border p-12 flex items-center justify-center min-h-[600px]" style={{ borderColor: 'rgba(91, 141, 239, 0.08)' }}>
                <div className="text-center max-w-md">
                  <div className="w-20 h-20 rounded-full mx-auto mb-6 flex items-center justify-center" style={{ backgroundColor: '#E0EDFF' }}>
                  ...
                  <p className="text-sm leading-relaxed" style={{ color: '#64748B' }}>
                    Completa el formulario a la izquierda con los datos del edificio y haz clic en <strong>"Ejecutar Análisis"</strong> para obtener resultados detallados.
                  </p>
                </div>
              </div>
            )}
