/**
 * Dashboard Principal de Due Diligence para CFO
...
export default function CFODueDiligenceDashboard() {
  ...
  const loadAnalysis = async () => {
    ...
    try {
      ...
      // Realizar análisis
      const analysisResult = await DueDiligenceService.analyzeBuilding(
        buildingId,
        building.name,
        financialData,
        building.price || 0
          ...
          <div className="bg-white border rounded-xl shadow-sm p-8 sm:p-12 text-center" style={{ borderColor: 'rgba(91, 141, 239, 0.08)', boxShadow: '0 1px 8px rgba(91, 141, 239, 0.06)' }}>
            <div className="max-w-md mx-auto">
              ...
              <p className="text-sm sm:text-base mb-6" style={{ color: '#64748B' }}>
                Para realizar un análisis de Due Diligence, primero necesitas cargar los datos financieros del activo.
              </p>
  ...
  // Determinar estilo del score general - Minimalista
                ...
                <div className="flex items-center gap-2 sm:gap-3 mb-2">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-[10px] sm:text-xs mt-0.5" style={{ color: '#64748B' }}>
                      Análisis Due Diligence • {new Date(analysis.analysisDate).toLocaleDateString('es-ES', {
                        day: 'numeric',
                        month: 'short',
                        year: 'numeric',
                        hour: '2-digit',
