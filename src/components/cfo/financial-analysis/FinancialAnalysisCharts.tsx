/**
 * Componente de Gráficos para Análisis Financiero
...
import type { ChartData } from '../../../types/financialAnalysis';
...
export function FinancialAnalysisCharts({ chartData }: Props) {
  const radarOptions = {
    responsive: true,
