...
import { CheckCircle, TrendingUp, AlertCircle, DollarSign, Calendar, Target, Clock, FileText, Scale, Settings, Wrench, Check } from 'lucide-react';
import type { DueDiligenceRecommendation, ActionItem } from '../../../types/dueDiligence';

interface Props {
  recommendation: DueDiligenceRecommendation;
}

export function DueDiligenceRecommendationComponent({ recommendation }: Props) {
