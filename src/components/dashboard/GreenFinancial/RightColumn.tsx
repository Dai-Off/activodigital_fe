  ...
  return (
    <>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
            ...
            <div className="space-y-2 text-xs">
              <div className="flex items-center justify-between"><span>• Deuda Senior Verde:</span><span className="font-semibold text-purple-700">9.65M€</span></div>
              <div className="flex items-center justify-between"><span>• Subvenciones Next Gen:</span><span className="font-semibold text-green-700">0.27M€</span></div>
              <div className="flex items-center justify-between"><span>• Equity / Sponsor:</span><span className="font-semibold text-blue-700">-8.57M€</span></div>
              <div className="border-t border-purple-300 pt-2 mt-2 flex items-center justify-between"><span className="text-xs font-semibold text-gray-800">Total:</span><span className="font-semibold text-purple-900">1.35M€</span></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className={`${cardBase}`}>
        ...
        <p className="text-xs text-gray-600 mb-4">Trazabilidad completa de documentos que soportan cada criterio</p>
      ...
      <div className={`${cardBase} relative tooltip-container group`}>
        <Button onClick={() => setMetricHelp((prev: any) => ({ ...prev, General: !prev.General }))} className="absolute top-1 right-1 rounded-full bg-white border-blue-200 border z-10">
          <CircleQuestionMarkIcon className="w-3 h-3 text-blue-600" />
        </Button>

        <h3 className="text-lg mb-4 flex items-center gap-2 text-[#1e3a8a]"><ChartColumnIcon className="w-5 h-5" />Métricas de Retorno</h3>
