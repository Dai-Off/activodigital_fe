          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="text-sm text-gray-600">
                {t("energyBuildings", "Edificios energéticos")}
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="text-sm text-gray-600">
                {t("completedBooks", "Libros completados")}
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="bg-white rounded-xl shadow-sm p-6">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h4 className="text-sm text-gray-600">
                  {t("totalSurface2", "Superficie Total")}
                </h4>
              </div>
              <div className="text-2xl text-gray-900">
                {stats.totalSurfaceArea > 0
                  ? stats.totalSurfaceArea.toLocaleString("es-ES", {
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h4 className="text-sm text-gray-600">
                  {t("dominantTypology", "Tipología Dominante")}
                </h4>
              </div>
              <div className="text-2xl text-gray-900">
                {stats.mostCommonTypology
                  ? stats.mostCommonTypology === "residential"
                    ? t("residential", "Residencial")
                    : stats.mostCommonTypology === "commercial"
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h4 className="text-sm text-gray-600">
                  {t("avgUnits2", "Promedio Unidades")}
                </h4>
              </div>
              <div className="text-2xl text-gray-900">
                {Math.round(stats.averageUnitsPerBuilding) || 0}
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h4 className="text-sm text-gray-600">
                  {t("avgAge2", "Edad Promedio")}
                </h4>
              </div>
              <div className="text-2xl text-gray-900">
                {stats.averageBuildingAge > 0
                  ? `${Math.round(stats.averageBuildingAge)} ${t(
                      "years",
                      "años"
                    )}`
                  : "-"}
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-xl shadow-sm p-6 h-full flex flex-col">
            <h3 className="text-base mb-6 text-center">
              {t("buildingBooksCompleted", "% libros del edificio completados")}
            </h3>
              ...
              <div className="relative w-40 h-40 mb-6">
                <svg className="transform -rotate-90 w-40 h-40">
                  ...
                  <circle
                    ...
                    fill="none"
                    strokeDasharray={`${
                      (stats.completionPercentage / 100) * 439.82
                    } 439.82`}
                    strokeLinecap="round"
                  />
                </svg>
