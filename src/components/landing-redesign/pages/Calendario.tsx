          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-gray-50 border-l-4 border-[#0ea5e9] p-8">
                ...
                <p className="text-gray-700 leading-relaxed">
                  El responsable de activo es el encargado de supervisar y gestionar todos los aspectos operativos de un edificio o conjunto de edificios. Este rol es crucial para asegurar que todas las tareas se realicen de manera eficiente y conforme a las normativas.
                </p>
              </div>
              ...
              <div className="bg-gray-50 border-l-4 border-[#0ea5e9] p-8">
                ...
                <p className="text-gray-700 leading-relaxed">
                  El director del fondo es el responsable de la gestión estratégica y operativa del fondo de inversión. Este rol implica tomar decisiones importantes sobre la adquisición y venta de propiedades, así como la supervisión de la gestión de los activos.
                </p>
              </div>
              ...
              <div className="bg-gray-50 border-l-4 border-[#0ea5e9] p-8">
                ...
                <p className="text-gray-700 leading-relaxed">
                  El departamento jurídico se encarga de asesorar y proteger a la empresa en todas las cuestiones legales relacionadas con la gestión de los activos. Esto incluye la revisión de contratos, la gestión de litigios y la aseguración de que todas las operaciones se realicen de manera legal y conforme a las regulaciones.
                </p>
              </div>
            </div>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              <div className="bg-gray-50 border-l-4 border-[#0ea5e9] p-8">
                <h3 className="text-xl font-semibold text-gray-900 mb-3">
                  Evitas multas que te arruinan el IRR
                </h3>
              ...
              <div className="bg-gray-50 border-l-4 border-[#0ea5e9] p-8">
                <h3 className="text-xl font-semibold text-gray-900 mb-3">
                  Reduces costes operativos 15-20%
                </h3>
                <p className="text-gray-600 leading-relaxed">
              ...
              <div className="bg-gray-50 border-l-4 border-[#0ea5e9] p-8">
                <h3 className="text-xl font-semibold text-gray-900 mb-3">
                  Desbloqueas ventas que estaban paradas
                </h3>
                <p className="text-gray-600 leading-relaxed">
