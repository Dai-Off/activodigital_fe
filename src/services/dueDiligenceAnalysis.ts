/**
 * Servicio de análisis de Due Diligence
...
export class DueDiligenceService {
  ...
  private static generateRecommendation(
    ...
    const { overall, financial, operational, technical } = scores;
  ...
  private static getEmptyMetrics(buildingValue: number): DueDiligenceMetrics {
    return {
      roi: null,
      noi: null,
      capRate: null,
  ...
  private static calculateFinancialScore(metrics: DueDiligenceMetrics): number {
    let score = 50; // Base
  ...
  private static calculateOperationalScore(metrics: DueDiligenceMetrics): number {
    let score = 40;
  ...
  private static calculateTechnicalScore(metrics: DueDiligenceMetrics, data: FinancialSnapshot | null): number {
    let score = 30;
  ...
  private static calculateMarketScore(metrics: DueDiligenceMetrics): number {
    let score = 50;
